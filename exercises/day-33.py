"""
🧠 Challenge: The Lamp: Revisited
🔗 Link: https://www.codewars.com/kata/570e6e32de4dc8a8340016dd
🏷️ Level: 6 kyu
📅 Date: 2025-11-22
...
if __name__ == "__main__":
    ...
    print(x.color)  # Red
    print(x.on)  # False
    print(x.state())  # The lamp is off.

# 📝 Note
"""
I didn't careful with the method's name. It made an error and i'm so confused.
"""
